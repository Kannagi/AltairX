...
void altairx_debug(uint32_t opcode,int type)
{
    uint32_t imm24,imm18,imm12,imm9,imm10,imm16;
    int rega,regb,regc,size,unit;
    char szf = 's';
    float immf;
    ...
    imm24 =  (opcode>>8)&0xFFFFFF;
    imm18 =  (opcode>>8)&0x3FFFF;
    imm12 =  (opcode>>8)&0xFFF;

    imm9 = (opcode>>10)&0x1FF;
