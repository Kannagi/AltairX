...
static int decodeBRU(uint32_t br, uint32_t pc, uint32_t opcode, ArOperation* AR_RESTRICT output)
{
...
static int decodeLSU(uint32_t opcode, ArOperation* AR_RESTRICT output)
{
    const uint32_t type = readbits(opcode, 2, 2);
...
static int decodeALU(uint32_t opcode, ArOperation* AR_RESTRICT output)
{
...
static int decodeAGU(uint32_t opcode, ArOperation* AR_RESTRICT output)
{
...
static int decodeVPU(uint32_t opcode, ArOperation* AR_RESTRICT output)
{
    (void)opcode;
    (void)output;
...
static int decode(uint32_t index, uint32_t br, uint32_t pc, uint32_t opcode, ArOperation* AR_RESTRICT output)
{
